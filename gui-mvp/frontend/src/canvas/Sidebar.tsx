...
type Props = {
  ...
  onAutoLayout: () => void
  onOpenSettings: () => void
  onOpenExportProfile: () => void
  onCreateFromPalette: (key: PaletteKey) => void
}

export default function Sidebar({
  palette, groups, onFocusGroup, onExportGroup, onUndo, onRedo, onSave, onAutoLayout, onOpenSettings, onCreateFromPalette, onOpenExportProfile,
}: Props) {
    ...
    >
      ...
      <div style={{ padding: 12, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        <div style={{ display: 'flex', gap: 8 }}>
          <Button size="small" onClick={onOpenExportProfile}>Export</Button>
